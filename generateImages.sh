...
do
	file=$(basename "$file")
	echo "$file"
	convert /media/sf_Screenshots/raw/"$file" -crop 420x28+1079+419 -colorspace Gray -brightness-contrast 30x100 -blur 0x1 /media/sf_Screenshots/processed/"$file".title.png
	convert /media/sf_Screenshots/raw/"$file" -crop 614x68+943+626 -blur 0x1 -negate /media/sf_Screenshots/processed/"$file".price.png
